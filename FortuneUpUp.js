...
function WhatisTodaysFortuneEvent(Fortune){
  ...
  let SpecialFestivalEvents = [
    ...
    {Date:"L12.30",name:"吃年夜饭",good:"无论身在何处，希望你可以能够和你所爱的欢度今宵",bad:null},
    {Date:"06.01",name:"像个孩子一样",good:"有多久没有像个孩子一样天真，憧憬未来了",bad:null},
    {Date:"06.07",name:"语文高考",good:"你的作文立意一定会很准确！",bad:null},
    {Date:"06.07",name:"数学高考",good:"你答对的所有基础题可以让你上985",bad:null},
    {Date:"06.08",name:"英语高考",good:"除了大小作文，你只扣个位数的分",bad:null},
    {Date:"06.08",name:"物理&历史高考",good:"考你都会的知识点",bad:null},
    {Date:"06.09",name:"四小科高考",good:"选择全对，大题全满分！",bad:null},
